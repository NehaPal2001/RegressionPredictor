...
<title>RegressIQ — Gap Alert</title>
<style>
...
<div class="email-outer">
  ...
  <div class="footer">
    <p>
      Generated by <strong>RegressIQ</strong> &nbsp;&middot;&nbsp;
...
def send_gap_alert(
    ...
    if html_body:
        ...
        lines = [
            f"RegressIQ detected {len(uncovered)} commit(s) not referenced in any "
    ...
    msg["Subject"] = (
        f"[RegressIQ] Requirement gap — {len(uncovered)} unplanned commit(s) "
